            ...
            children: [
              Form(
                ...
                child: Column(
                  children: [
                    TextFormField(
                      validator: (val){
                        return val.isEmpty || val.length < 3 ? "Lütfen isminizi giriniz" : null;
                      },
                      onChanged: (value){
                        username = value;
                      },
                    ...
                    TextFormField(
                      validator: (val){
                        return RegExp(r"^[a-zA-Z0-9.a-zA-Z0-9.!#$%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9]+\.[a-zA-Z]+").hasMatch(val) ? null : "Please provide a valid email address";
                    ...
                    TextFormField(
                      ...
                      validator: (val){
                        return val.length > 8 ? null : "Lütfen 8 karakterden fazla şifre giriniz";
                      },
                      decoration: textField("Şifre"),
                    ),
                    TextFormField(
                      validator: (val){
                        if(double.tryParse(val) != null || int.tryParse(val) != null){
                          return null;
                        }
                        return "Sayı Giriniz";
                      },
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text("Kayıt Ol", style: simpleTextStyle(),
                  ),
                ),
              ),
              SizedBox(height: 16,),
